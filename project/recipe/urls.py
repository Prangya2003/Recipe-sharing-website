...
from .views import create_recipe_view,delete_recipe_view,update_recipe_view,recipe_detail,post_comment
urlpatterns = [
    ...
    path('post-comment/<int:id>/', post_comment, name='post_comment'),
